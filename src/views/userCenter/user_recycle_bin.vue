  ...
  <div>
    ...
    <el-table :data="userList" style="width: 100%">
      ...
      <el-table-column :label="t('operates')" align="center">
        <template #default="scope">
          <el-popconfirm width="230" cancel-button-type="default" :confirm-button-text="t('confirm_ok_text')"
            :cancel-button-text="t('confirm_cancel_text')" icon="Warning" icon-color="#409eff"
            :title="t('sure_Restore')" @confirm="handleRestore(scope.row.id)">
            <template #reference>
              <el-button>{{ t('restore') }}</el-button>
            </template>
          </el-popconfirm>
          <el-popconfirm width="230" cancel-button-type="default" :confirm-button-text="t('confirm_ok_text')"
            :cancel-button-text="t('confirm_cancel_text')" icon="Warning" icon-color="rgb(238, 44, 44)"
            :title="t('shift_delete')" @confirm="deleteItem(scope.row.id)">
            <template #reference>
