...
const zh = {
  ...
  tour_step: "第{currentStep}步",
  tour_start: "开始",
  tour_complete: "完成",
  tour_nextStep: "下一步（{currentStep} / {totalSteps}）",
  tour_prev: "上一步",
  tour_skip: "跳过",
  tour_welcomeTitle: "欢迎来到kilyicms",
  tour_welcomeDescription: "点击继续开始介绍",
  tour_menuDescription: "左边菜单栏",
  tour_toggleButtonDescription: "展开折叠按钮",
  tour_breadcrumbDescription: "面包屑导航",
  tour_tabNavigationDescription: "标签页导航",
  tour_menuSearchDescription: "菜单搜索",
  tour_fullscreenDescription: "全屏切换",
  tour_themeSwitchDescription: "主题切换",
  tour_languageSwitchTitle: "国际化",
  tour_languageSwitchDescription: "多语言切换",
  tour_notificationDescription: "消息通知",
