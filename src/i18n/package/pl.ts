const pl = {
  ...
  router_user: "ustawienia użytkownika",
  ...
  router_Functions_and_Components: "Funkcje i komponenty",
  ...
  hello_editor_page: "Witamy na stronie głównej roli {user}.",
  ...
  function_card: "Karta funkcyjna",
  customSwitchComponent: "Niestandardowy komponent przełącznika",
  iconIntegration: "{unocs} integruje ikonę etykiety {iconify}",
  ...
  permissionExample: "Przykład dyrektywy w sprawie zezwoleń",
  clickHereToExample: "Kliknij tutaj, aby przejść do strony przykładowej",
  ...
  character: "Znak",
  Please_select_your_role: "Proszę wybrać swoją rolę",
