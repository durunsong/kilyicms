const el = {
  ...
  dark: "σκούρο",
  shift_delete:
    "Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το στοιχείο εντελώς;",
  restore: "Επαναφορά",
  ...
  Please_enter_your_verification_code:
    "Παρακαλώ εισάγετε τον κωδικό επαλήθευσης",
  ...
  Reimagining_atomized_CSS:
    "Συνιστώμενη ανάγνωση: Αναθεώρηση του ψεκασμένου {CSS}",
  ...
  warning_set_watermark_after_dom_mount:
    "Παρακαλώ καλέστε την {μέθοδο} αφού τοποθετηθεί το {dom}.",
  Please_recreate_it_watermark:
    "Το στοιχείο υδατογραφήματος δεν υπάρχει. Παρακαλώ ξαναδημιουργήστε το.",
